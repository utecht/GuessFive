...
class ThingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thing" do
    assert_difference("Thing.count") do
      post things_url, params: { thing: { img: @thing.img, link: @thing.link, name: @thing.name } }
    end
  ...
  test "should update thing" do
    patch thing_url(@thing), params: { thing: { img: @thing.img, link: @thing.link, name: @thing.name } }
